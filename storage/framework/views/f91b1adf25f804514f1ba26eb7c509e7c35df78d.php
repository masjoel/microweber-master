...
<body class="is_admin loading view-content action-pages">

<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('livewire-ui-modal')->html();
} elseif ($_instance->childHasBeenRendered('YLbH4eO')) {
    $componentId = $_instance->getRenderedChildComponentId('YLbH4eO');
    $componentTag = $_instance->getRenderedChildComponentTagName('YLbH4eO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('YLbH4eO');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('YLbH4eO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<script>
    ...
    function mw_select_page_for_editing($p_id) {
        ...
        //var active_item = $('#pages_tree_container_4199703632 .active-bg').first();
        ...
        var active_item = $('#pages_tree_container_4199703632 .content-item-' + active_item_is_parent).first();
        ...
        if (active_item_is_category ) {
            var active_item_parent_page = $('#pages_tree_container_4199703632 .active-bg').parents('.have_category').first();
            if (active_item_parent_page.length) {
                 active_item_is_page = active_item_parent_page.attr('data-page-id');
            }
            else {
                active_item_parent_page = $('#pages_tree_container_4199703632 .active-bg').parents('.is_page').first();
                if (active_item_parent_page.length) {
                     active_item_is_page = active_item_parent_page.attr('data-page-id');
                }
            }
    ...
    function mw_select_custom_content_for_editing($p_id, $type) {
        ...
        if (active_item_is_category != undefined) {
            ...
            var active_bg = document.querySelector('#pages_tree_container_4199703632 .active-bg');
...
<div id="edit-content-row">
        ...
        <div class="js-tree tree">
            <div class="tree-column-holder">
                ...
                <div class="fixed-side-column">
                    ...
                    <div class="fixed-side-column-container mw-tree" id="pages_tree_container_4199703632">
                        <script>
                            var pagesTree;
                                    ...
                                    if (request.status >= 200 && request.status < 400) {
                                        ...
                                        if(!data || !data.length){
                                            ...
                                            pagesTree = new mw.tree({
                                                data: data,
                                                element: $("#pages_tree_container_4199703632")[0],
                                                sortable: false,
                                                selectable: false,
                                                toggleSelect: false,
                                                id: 'admin-main-tree',
    ...
    <div id="pages_edit_container"  content_type='page'  '   ></div>
</div>
</div>        
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/9340a55a0bfcdd4fd32f9f543f6ff2d4f3434306.blade.php ENDPATH**/ ?>