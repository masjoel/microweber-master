...
} elseif ($_instance->childHasBeenRendered('lAeitM1')) {
    $componentId = $_instance->getRenderedChildComponentId('lAeitM1');
    $componentTag = $_instance->getRenderedChildComponentTagName('lAeitM1');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lAeitM1');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('lAeitM1', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
        ...
        <aside>
            ...
            <ul class="nav flex-column" id="mw-admin-main-navigation">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link   active " href="http://127.0.0.1:8000/admin/view:settings#option_group=all">
...
<script type="text/javascript">
    mw.require("options.js");
    mw.require("http://127.0.0.1:8000/userfiles/modules/settings/settings.css");
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/d3a1436f5d1f157aa434f97132bddaad9a5807b2.blade.php ENDPATH**/ ?>