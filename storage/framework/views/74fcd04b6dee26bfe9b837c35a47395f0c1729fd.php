...
} elseif ($_instance->childHasBeenRendered('sKQmESJ')) {
    $componentId = $_instance->getRenderedChildComponentId('sKQmESJ');
    $componentTag = $_instance->getRenderedChildComponentTagName('sKQmESJ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('sKQmESJ');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('sKQmESJ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://127.0.0.1:8000/api/page/1" id="quickform-edit-content" autocomplete="off">
        ...
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-16789101" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-16789101" value="page">
        <input type="hidden" name="parent" id="mw-parent-page-value-16789101" value="0" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-16789101" value="index.php">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-16789101" value="">
...
<script>
    ...
    mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991 = {
        set: function () {
        ...
        rend: function (url) {
            ...
            frame.onload = function (ev) {
                mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.set();
        ...
        next: function () {
            var index = mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.selectedIndex;
            var next = mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.options[index + 1] !== undefined ? (index + 1) : 0;
            mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view(next);
        },
        prev: function () {
            var index = mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.selectedIndex;
            var prev = mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.options[index - 1] !== undefined ? (index - 1) : mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.options.length - 1;
            mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view(prev);
        },
        view: function (which) {
            mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector.selectedIndex = which;
            mw.$("#layout_selectora6b1c06973c326d761b9d139eb3b8991 li.active").removeClass('active');
            mw.$("#layout_selectora6b1c06973c326d761b9d139eb3b8991 li").eq(which).addClass('active');
            $(mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector).trigger('change');
        },
        setHeight: function () {
        ...
        generate: function (return_url) {
            ...
            var template = mw.$('#active_site_template_a6b1c06973c326d761b9d139eb3b8991 option:selected').val();
            var layout = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991').val();
            var is_shop = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991 option:selected').attr('data-is-shop');
            var ctype = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991 option:selected').attr('data-content-type');
            var stype = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991 option:selected').attr('data-subtype');
            var stype_val = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991 option:selected').attr('data-subtype-value');
            var inherit_from = mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991 option:selected').attr('inherit_from');


            var root = document.querySelector('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991');
            ...
            if (return_url == undefined) {
                mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.rend(iframe_url);
                            } else {
                return (iframe_url);
            }
    ...
    $(document).ready(function () {
        ...
        mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.selector = document.getElementById('active_site_layout_a6b1c06973c326d761b9d139eb3b8991');

        $('select#active_site_template_a6b1c06973c326d761b9d139eb3b8991').on("change", function (e) {
            ...
            if (parent_module != undefined) {
              ...
              //  $(this).selectpicker('destroy');
                ...
                mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.generate();
        ...
        mw.$('#active_site_layout_a6b1c06973c326d761b9d139eb3b8991').on("change", function (e) {
            mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.generate();
            mw.trigger('templateChanged');
        });
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div>
                                                <select name="preview_layout_file" class="selectpicker mw-edit-page-layout-selector" data-width="100%" data-live-search="true" data-size="7" id="active_site_layout_a6b1c06973c326d761b9d139eb3b8991" autocomplete="off">
                                                                                                                                                                                                                                                                                                <option value="index.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('0');" data-index="0" data-layout_file="index.php" selected data-content-type="static" title="Home">
                                                                Home                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__shop.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('1');" data-index="1" data-layout_file="layouts__shop.php" data-content-type="dynamic" data-is-shop="y" title="Shop">
                                                                Shop        (shop)                                                             </option>
                                                                                                                                                                                                                                                <option value="layouts__blog.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('2');" data-index="2" data-layout_file="layouts__blog.php" data-content-type="dynamic" title="Blog">
                                                                Blog                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__services.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('3');" data-index="3" data-layout_file="layouts__services.php" data-content-type="static" title="Services">
                                                                Services                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__about.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('4');" data-index="4" data-layout_file="layouts__about.php" data-content-type="static" title="About us">
                                                                About us                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__contacts.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('5');" data-index="5" data-layout_file="layouts__contacts.php" data-content-type="static" title="Contacts">
                                                                Contacts                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__sign-up.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('6');" data-index="6" data-layout_file="layouts__sign-up.php" data-content-type="static" title="Sign up">
                                                                Sign up                                                                </option>
                                                                                                                                                                                                                                                <option value="forgot_password.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('7');" data-index="7" data-layout_file="forgot_password.php" data-content-type="static" title="Forgot password">
                                                                Forgot password                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__text-page.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('8');" data-index="8" data-layout_file="layouts__text-page.php" data-content-type="static" title="Text page">
                                                                Text page                                                                </option>
                                                                                                                                                                                                                                                <option value="login.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('9');" data-index="9" data-layout_file="login.php" data-content-type="static" title="Login">
                                                                Login                                                                </option>
                                                                                                                                                                                                                                                <option value="register.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('10');" data-index="10" data-layout_file="register.php" data-content-type="static" title="Register">
                                                                Register                                                                </option>
                                                                                                                                                                                                                                                <option value="404.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('11');" data-index="11" data-layout_file="404.php" data-content-type="static" title="Error 404">
                                                                Error 404                                                                </option>
                                                                                                                                                                                                                                                <option value="clean.php" onclick="mw.templatePreviewa6b1c06973c326d761b9d139eb3b8991.view('12');" data-index="12" data-layout_file="clean.php" data-is-default="true" data-content-type="static" title="Clean">
                                                                Clean                                                                </option>
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-62f3befd1e791">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_62f3befd1e791"></div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-62f3befd2c3c0');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-62f3befd2c3c0',
            nav: 'dropdown',
            footer: false,
            boxed: false,
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0" style="display: none">Drop here</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-62f3befd2c3c0');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-62f3befd2c3c0');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-62f3befd2c3c0 .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-62f3befd2c3c0").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-62f3befd2c3c0">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-62f3befd1e791');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_62f3befd1e791',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            <div class="mw-admin-edit-post-updated-at" onclick="mw.adm_cont_enable_edit_of_updated_at()">
                                                <small>
                                                    Updated on: <span class="mw-admin-edit-post-display-updated-at-value">2021-04-29 12:42:28</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-updated-at-value" style="display:none" type="text" name="updated_at" value="2021-04-29 12:42:28">
                                                </small>
                                            </div>
                                        </div>
                                                                    </div>
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-16789101').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-16789101', '#module-content-edit').val();
        var content_id = mw.$('#mw-content-id-value', '#module-content-edit').val();
        var content_type = mw.$('#mw-content-type-value-16789101', '#module-content-edit').val()
        var subtype = mw.$('#mw-content-subtype', '#module-content-edit').val();
        var subtype_value = mw.$('#mw-content-subtype-value-16789101', '#module-content-edit').val();
        var active_site_template = $('#mw-active-template-value-16789101', '#module-content-edit').val();
        var active_site_layout = $('#mw-layout-file-value-16789101').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-16789101').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-16789101').val(0).trigger("change");
        }
    }
...
<input type="hidden" name="is_active" id="is_post_active" value="1">
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            mw.$('#content_selector_62f3befd2846a').on('change', function (e) {
                var val = $(this).val();
...
<select name="parent_id_selector" data-width="100%" class="selectpicker selector-module-content-views-selector" id="content_selector_62f3befd2846a" title="Select a parent page">
...
<div class="position-relative" id="menu-selector-item">
            <div id="mw-menu-selector-list-62f3befd2b0c4" class="mw-menu-selector-list">
                            <div class="form-group">
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/90b2b9ff48fd7bf8e8649a019641b792c3a8b2d7.blade.php ENDPATH**/ ?>