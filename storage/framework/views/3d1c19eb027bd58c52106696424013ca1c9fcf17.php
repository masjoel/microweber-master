...
} elseif ($_instance->childHasBeenRendered('bsciLRY')) {
    $componentId = $_instance->getRenderedChildComponentId('bsciLRY');
    $componentTag = $_instance->getRenderedChildComponentTagName('bsciLRY');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('bsciLRY');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('bsciLRY', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/86c4033cd8a236d338c3f5aa66812f31a08bf958.blade.php ENDPATH**/ ?>