...
} elseif ($_instance->childHasBeenRendered('j5SYWD8')) {
    $componentId = $_instance->getRenderedChildComponentId('j5SYWD8');
    $componentTag = $_instance->getRenderedChildComponentTagName('j5SYWD8');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('j5SYWD8');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('j5SYWD8', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            ...
            <ul class="nav flex-column" id="mw-admin-main-navigation">
                <li class="nav-item">
                    <a href="http://127.0.0.1:8000/admin/" class="nav-link ">
                        ...
                        <div class="dropdown-menu">
                            <a href="http://127.0.0.1:8000/admin/view:content/action:pages" class="dropdown-item  active ">
...
<div class="form-group text-center">
    ...
    <main class="module-">
                    ...
                    <div class=' module module-content-edit ' id='module-content-edit'  content_id="1"   content_type="page"   data-type="content/edit"   parent-module="content/edit"   parent-module-id="module-content-edit"  >
...
<div class="in-window">
    ...
    <form method="post" class="mw_admin_edit_content_form  " action="http://127.0.0.1:8000/api/page/1" id="quickform-edit-content" autocomplete="off">

                    <input name="_method" type="hidden" value="PATCH">
        
        <input type="hidden" name="id" id="mw-content-id-value" value="1">
        <input type="hidden" name="subtype" id="mw-content-subtype" value="static">
        <input type="hidden" name="subtype_value" id="mw-content-subtype-value-1203357060" value="">
        <input type="hidden" name="content_type" id="mw-content-type mw-content-type-value-1203357060" value="page">
        <input type="hidden" name="parent" id="mw-parent-page-value-1203357060" value="0" class="">
        <input type="hidden" name="layout_file" id="mw-layout-file-value-1203357060" value="index.php">
        <input type="hidden" name="active_site_template" id="mw-active-template-value-1203357060" value="">
                ...
                <div class="content-title-field-row card style-1 mb-3 border-0" id="content-title-field-row">
                    <div class="card-header-fix">
                        <div class="card-header">
                                                        <h5>
<i class="mdi mdi-file-document text-primary mr-3"></i> <strong>Editing page</strong>
</h5>
                            ...
                            <div id="content-title-field-buttons">
                                                                            ...
                                                                            <a title="Live Edit" href="http://127.0.0.1:8000/?editmode=y" class="btn   btn-outline-primary  btn-sm  btn-sm-only-icon mw-admin-go-live-now-btn mx-1">
                                            <span>Live Edit</span>
                                        </a>
                            ...
                            <div class="form-group" id="slug-field-holder">
                                ...
                                <input type="text" class="form-control" name="title" value="Home" id="content-title-field" onkeyup="slugFromTitle();" autocomplete="">
                                    ...
                                    <span class="mw-admin-post-slug-text">
                                        ...
                                        <span class="contenteditable js-slug-base-url" data-bs-toggle="tooltip" data-title="edit" data-placement="right" contenteditable="true">home</span>
                                    </span>
                                  </div>

                                <div class="d-none">
                                    <input autocomplete="off" name="url" id="edit-content-url" class="js-slug-base-url-changed edit-post-slug" type="text" value="home">
                ...
                <div class="admin-manage-content-wrap">
                                                                        ...
                                                                        <div class=' module module-content-views-layout-selector '   id="mw-quick-add-choose-layout-middle-pos"   autoload="yes"   template-selector-position="top"   live-edit-btn-overlay="true"   content-id="1"   edit_page_id="1"   inherit_from="0"   small="true"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="content/views/layout_selector"  >
<script>
    ...
    mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2 = {
        set: function () {
        ...
        rend: function (url) {
            ...
            frame.onload = function (ev) {
                mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.set();
        ...
        next: function () {
            var index = mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.selectedIndex;
            var next = mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.options[index + 1] !== undefined ? (index + 1) : 0;
            mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view(next);
        },
        prev: function () {
            var index = mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.selectedIndex;
            var prev = mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.options[index - 1] !== undefined ? (index - 1) : mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.options.length - 1;
            mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view(prev);
        },
        view: function (which) {
            mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector.selectedIndex = which;
            mw.$("#layout_selector33bff9a7e9fa79f3ba0c952f3ea127c2 li.active").removeClass('active');
            mw.$("#layout_selector33bff9a7e9fa79f3ba0c952f3ea127c2 li").eq(which).addClass('active');
            $(mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector).trigger('change');
        },
        setHeight: function () {
        ...
        generate: function (return_url) {
            ...
            var template = mw.$('#active_site_template_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').val();
            var layout = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2').val();
            var is_shop = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').attr('data-is-shop');
            var ctype = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').attr('data-content-type');
            var stype = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').attr('data-subtype');
            var stype_val = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').attr('data-subtype-value');
            var inherit_from = mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2 option:selected').attr('inherit_from');


            var root = document.querySelector('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2');
            ...
            var iframe_url = 'http://127.0.0.1:8000/?no_editmode=true' + preview_template_param + preview_layout_param + '&content_id=1' + inherit_from_param + preview_layout_content_type_param
            if (return_url == undefined) {
                mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.rend(iframe_url);
                            } else {
                return (iframe_url);
            }
    ...
    $(document).ready(function () {
        ...
        mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.selector = document.getElementById('active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2');

        $('select#active_site_template_33bff9a7e9fa79f3ba0c952f3ea127c2').on("change", function (e) {
            ...
            if (parent_module != undefined) {
              ...
              //  $(this).selectpicker('destroy');
                ...
                mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.generate();
        ...
        mw.$('#active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2').on("change", function (e) {
            mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.generate();
            mw.trigger('templateChanged');
        });
...
<div>
    ...
    <div class="layouts_box_holder">
        <div class="content-title-field-row card style-1  mb-3">
            <div class="card-header">
                <h5>
<i class="mdi mdi-text-box-check-outline text-primary mr-3"></i>

                                            <strong>Template</strong> - New World                                    </h5>
                <div></div>
            </div>
            <div class="card-body pt-3">
                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <div>
                                                <select name="preview_layout_file" class="selectpicker mw-edit-page-layout-selector" data-width="100%" data-live-search="true" data-size="7" id="active_site_layout_33bff9a7e9fa79f3ba0c952f3ea127c2" autocomplete="off">
                                                                                                                                                                                                                                                                                                <option value="index.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('0');" data-index="0" data-layout_file="index.php" selected data-content-type="static" title="Home">
                                                                Home                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__shop.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('1');" data-index="1" data-layout_file="layouts__shop.php" data-content-type="dynamic" data-is-shop="y" title="Shop">
                                                                Shop        (shop)                                                             </option>
                                                                                                                                                                                                                                                <option value="layouts__blog.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('2');" data-index="2" data-layout_file="layouts__blog.php" data-content-type="dynamic" title="Blog">
                                                                Blog                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__services.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('3');" data-index="3" data-layout_file="layouts__services.php" data-content-type="static" title="Services">
                                                                Services                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__about.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('4');" data-index="4" data-layout_file="layouts__about.php" data-content-type="static" title="About us">
                                                                About us                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__contacts.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('5');" data-index="5" data-layout_file="layouts__contacts.php" data-content-type="static" title="Contacts">
                                                                Contacts                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__sign-up.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('6');" data-index="6" data-layout_file="layouts__sign-up.php" data-content-type="static" title="Sign up">
                                                                Sign up                                                                </option>
                                                                                                                                                                                                                                                <option value="forgot_password.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('7');" data-index="7" data-layout_file="forgot_password.php" data-content-type="static" title="Forgot password">
                                                                Forgot password                                                                </option>
                                                                                                                                                                                                                                                <option value="layouts__text-page.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('8');" data-index="8" data-layout_file="layouts__text-page.php" data-content-type="static" title="Text page">
                                                                Text page                                                                </option>
                                                                                                                                                                                                                                                <option value="login.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('9');" data-index="9" data-layout_file="login.php" data-content-type="static" title="Login">
                                                                Login                                                                </option>
                                                                                                                                                                                                                                                <option value="register.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('10');" data-index="10" data-layout_file="register.php" data-content-type="static" title="Register">
                                                                Register                                                                </option>
                                                                                                                                                                                                                                                <option value="404.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('11');" data-index="11" data-layout_file="404.php" data-content-type="static" title="Error 404">
                                                                Error 404                                                                </option>
                                                                                                                                                                                                                                                <option value="clean.php" onclick="mw.templatePreview33bff9a7e9fa79f3ba0c952f3ea127c2.view('12');" data-index="12" data-layout_file="clean.php" data-is-default="true" data-content-type="static" title="Clean">
                                                                Clean                                                                </option>
...
<div id="settings-tabs">
    <div class="card style-1 mb-3 images">
        ...
        <div class="card-body pt-3">
            <div class='pictures-admin-content-type-page module module-pictures-admin '   data-mw-title="Picture Gallery" id="edit-post-gallery-main"   for="content"   content_type="page"   for-id="1"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="pictures/admin"  >    <script type="text/javascript">
    ...
    mw_admin_pictures_upload_browse_existing = function () {
        ...
        $(dialog.iframe).on('load', function () {
            this.contentWindow.mw.on.hashParam('select-file', function (pval) {
                after_upld(pval, 'save', 'content', '1', 'edit-post-gallery-main');

                after_upld(pval, 'done', 'content', '1', 'edit-post-gallery-main');
...
<div class="left pt-3" style="clear:both" id="admin-thumbs-holder-sort-62f3bf930c085">

    <div class="relative post-thumb-uploader m-t-10" id="backend_image_uploader_62f3bf930c085"></div>



    <div class="admin-thumbs-holder">
                    <div class=' module module-pictures-admin-backend-sortable-pics-list ' id='edit-post-gallery-main-pictures-admin-backend-sortable-pics-list'  for="content"   for_id="1"   parent-module-id="edit-post-gallery-main"   parent-module="pictures/admin"   data-type="pictures/admin_backend_sortable_pics_list"  >
<script>
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-pic-sorter-62f3bf933ee0d');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_pic-sorter-62f3bf933ee0d',
            nav: 'dropdown',
            footer: false,
            boxed: false,
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            ...
            after_upld(url, 'Result', 'content', '1', 'edit-post-gallery-main-pictures-admin-backend-sortable-pics-list');
            after_upld(url, 'done');
...
<div class="mw-drop-zone" id="admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d" style="display: none">Drop here</div>


<script>
    $(document).ready(function () {
        mw.module_pictures.init('#admin-thumbs-holder-sort-pic-sorter-62f3bf933ee0d');

        var uploadHolder = mw.$('#admin-thumb-item-uploaderpic-sorter-62f3bf933ee0d');
        ...
        mw._postsImageUploaderSmall = mw.upload({
            ...
            accept: 'image/*',
            multiple: true,
            dropZone: '#admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d',
            on: {
        ...
        if (!mw.$('#admin-thumbs-holder-sort-pic-sorter-62f3bf933ee0d .admin-thumb-item').length) {
            uploadHolder.hide();
        ...
        $(document).on('dragover', function (e) {
            ...
            if (dt.types && (dt.types.indexOf ? dt.types.indexOf('Files') !== -1 : dt.types.contains('Files'))) {
                $("#admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d").show();
                clearTimeout(dragTimer);
            }
        });
        $(document).on('dragleave', function (e) {
            dragTimer = setTimeout(function () {
                $("#admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d").hide();
            }, 25);
        });

        $("#admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d").on('drop', function () {
            $("#admin-thumbs-drop-zone-pic-sorter-62f3bf933ee0d").hide();
        });
...
<div class="admin-thumbs-holder" id="admin-thumbs-holder-sort-pic-sorter-62f3bf933ee0d">
    ...
    $(document).ready(function () {
        ...
        var $root = mw.$('#admin-thumbs-holder-sort-62f3bf930c085');

        mw.require('filepicker.js');

        mw._postsImageUploader = new mw.filePicker({
            element: '#backend_image_uploader_62f3bf930c085',
            nav: 'dropdown',
            footer: false,
            boxed: false,
            dropDownTargetMode: 'dialog',
        ...
        $(mw._postsImageUploader).on('Result', function (e, res) {
            var url = res && res.src ? res.src : res;
            after_upld(url, 'Result', 'content', '1', 'edit-post-gallery-main');
            after_upld(url, 'done');
            if (mw._postsImageUploader.settings.hideHeader) {
                mw._postsImageUploader.hide()
            } else {
        ...
        <div class="card style-1 mb-3 card-collapse fields js-custom-fields-card-tab">
            ...
            <div class="card-body py-0">
                <div class="collapse" id="custom-fields-settings">
                    <div class=' module module-custom-fields-admin '   data-mw-title="Custom fields" content-id="1"   suggest-from-related="true"   list-preview="true"   id="fields_for_post_1"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="custom_fields/admin"  >


<div class="card style-1 mb-3 ">
    <div class="card-header">
        <div class=' module module-admin-modules-info-module-title ' id='fields-for-post-1-admin-modules-info-module-title'  for-module="custom_fields/admin"   parent-module-id="fields_for_post_1"   parent-module="custom_fields/admin"   data-type="admin/modules/info_module_title"  ><h5>
        ...
        <div class="settings-wrapper">
            ...
            <script>
                ...
                function addCustomFieldByExisting(fieldId) {
                    ...
                    //   mw.custom_fields.copy_field_by_id(fieldId, 'content', '1');
                ...
                $(document).ready(function () {
                    ...
                    mw.$('.js-cf-options').on('change', function () {
                        ...
                        if (copyof == false) {
                            ...
                            // mw.custom_fields.copy_field_by_id(copyof, 'content', '1');
                        }
                    });
                });
            ...
            <div class="module-live-edit-settings">
                <div id="custom-field-editor" class="mw-ui-box mw-ui-box-content" style="display: none">
                    ...
                    <div class="custom-field-edit">
                        ...
                        <div class="mw-admin-custom-field-edit-item-wrapper">
                            <div class="mw-admin-custom-field-edit-item mw-admin-custom-field-edit-fields_for_post_1"></div>
                        </div>
                    </div>
                </div>
                ...
                <div id="custom-fields-box">
                    ...
                    <div class=' module module-custom-fields-list '   data-type="custom_fields/list"   for="content"   rel_id="1"   list-preview="true"   id="mw_custom_fields_list_preview"   parent-module-id="fields_for_post_1"   parent-module="custom_fields/admin"  ><script>
...
<script>
    ...
    $(document).ready(function (){
        ...
        <div class=' module module-help-modal-with-button ' id='fields-for-post-1-help-modal-with-button'  for_module="custom_fields"   parent-module-id="fields_for_post_1"   parent-module="custom_fields/admin"   data-type="help/modal_with_button"  ><script>
...
<a href="javascript:;" onclick="openModalHelpReadmeMd('custom_fields');"><i class="fa fa-info-circle"></i> Help</a>
    ...
    <div class=' module module-content-views-advanced-settings ' id='module-content-edit-content-views-advanced-settings'  content-id="1"   content-type="page"   subtype="static"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="content/views/advanced_settings"  >    <script type="text/javascript">
        mw.lib.require('mwui_init');
    </script>
    <script type="text/javascript">
    ...
    <div class=' module module-content-views-settings-from-template ' id='module-content-edit-content-views-advanced-settings-content-views-settings-from-template'  content-type="page"   content-id="1"   parent-module-id="module-content-edit-content-views-advanced-settings"   parent-module="content/views/advanced_settings"   data-type="content/views/settings_from_template"  ></div>
            ...
            <div class="collapse" id="advanced-settings">
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-8">
                        ...
                        <a class="btn btn btn-outline-primary btn-sm" href="javascript:open_edit_related_content_modal('1');">Edit related</a>
                    </div>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-md-12 text-center text-md-left">
                        ...
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.copy_current_page('1');">Duplicate</a> 
                        <a class="btn btn-outline-primary btn-sm" href="javascript:mw.reset_current_page('1');">Reset Content</a>
                        <a class="btn btn-outline-danger btn-sm" id="mw-admin-content-edit-inner-delete-curent-content-btn" href="javascript:mw.del_current_page('1');">Delete Content</a>
                        ...
                        <div class="col-12">
                            <div class="form-group">
                                ...
                                <div class="custom-control custom-switch pl-0">
                                    ...
                                    <input type="checkbox" name="is_home" class="custom-control-input" id="is_home" data-value-checked="1" data-value-unchecked="0" checked>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div>
                                <small>
                                    Id: <span class="mw-admin-edit-post-display-id-at-value">1</span>
                                    ...
                                    <script>
                                        $(function () {
                                            ...
                                            <div class="mw-admin-edit-post-created-at" onclick="mw.adm_cont_enable_edit_of_created_at()">
                                                <small>
                                                    Created on: <span class="mw-admin-edit-post-display-created-at-value">2020-01-21 10:14:04</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-created-at-value" style="display:none" type="text" name="created_at" value="2020-01-21 10:14:04">
                                                </small>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mw-admin-edit-post-updated-at" onclick="mw.adm_cont_enable_edit_of_updated_at()">
                                                <small>
                                                    Updated on: <span class="mw-admin-edit-post-display-updated-at-value">2022-08-10 14:23:55</span>
                                                    <input class="form-control form-control-sm mw-admin-edit-post-change-updated-at-value" style="display:none" type="text" name="updated_at" value="2022-08-10 14:23:55">
                                                </small>
                                            </div>
                                        </div>
                                                                    </div>
...
<script>
    ...
    mw.edit_content.close_alert = function () {
        ...
        mw.$('#post-added-alert-1203357060').hide();

    };

    mw.edit_content.load_page_preview = function (element_id) {
        var element_id = element_id || 'mw-admin-content-iframe-editor';
        var parent_page = mw.$('#mw-parent-page-value-1203357060', '#module-content-edit').val();
        var content_id = mw.$('#mw-content-id-value', '#module-content-edit').val();
        var content_type = mw.$('#mw-content-type-value-1203357060', '#module-content-edit').val()
        var subtype = mw.$('#mw-content-subtype', '#module-content-edit').val();
        var subtype_value = mw.$('#mw-content-subtype-value-1203357060', '#module-content-edit').val();
        var active_site_template = $('#mw-active-template-value-1203357060', '#module-content-edit').val();
        var active_site_layout = $('#mw-layout-file-value-1203357060').val();
    ...
    mw.edit_content.set_category = function (id) {
        ...
        if (names.length > 0) {
            mw.$('#mw-parent-page-value-1203357060').val(names[0]).trigger("change");
        } else {
            mw.$('#mw-parent-page-value-1203357060').val(0).trigger("change");
        }
    }
...
<script>
    $(mwd).ready(function () {
        ...
        mw.edit_content.load_editor();
                // mw.edit_content.render_category_tree("1203357060");
        mw.$("#quickform-edit-content").submit(function () {
            mw.edit_content.handle_form_submit();
            return false;
        });
                mw.$(".mw-admin-go-live-now-btn").attr('content-id', 1);
                mw.$('#mw-parent-page-value-1203357060').on('change', function (e) {
        ...
        mw.$(".admin-manage-toolbar").on("mousemove", function () {
            mw.tools.removeClass(document.body, 'editorediting');
                ...
                <script>
        $(document).ready(function () {
            $('.go-live-edit-href-set').attr('href', 'http://127.0.0.1:8000/?editmode=y');
            $('.go-live-edit-href-set-view').attr('href', 'http://127.0.0.1:8000/?editmode=n');
        });
    </script>
            ...
            <div class="card-body pt-3 pb-1">
                <div class="row">
                            ...
                            <div class="quick-parent-selector mt-2">
                                <div class=' module module-content-views-selector ' id='module-content-edit-content-views-selector'  no-parent-title="No parent page"   field-name="parent_id_selector"   change-field="parent"   selected-id="0"   remove_ids="1"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="content/views/selector"  >
    <script type="text/javascript">
        $(document).ready(function () {
            mw.$('#content_selector_62f3bf93266fb').on('change', function (e) {
                var val = $(this).val();
...
<select name="parent_id_selector" data-width="100%" class="selectpicker selector-module-content-views-selector" id="content_selector_62f3bf93266fb" title="Select a parent page">
    
    <option value="0"    selected="selected"  >No parent page</option>

    </option><option class='pages_tree_item have_category is_blog   depth-1 item_2 first-child  child-0 menu-item-id-2' data-page-id='2' value='2'  data-item-id='2'   data-parent-page-id='0'  data-subtype='dynamic'     title='Blog' >Blog</option><option class='pages_tree_item have_category is_shop   depth-1 item_8 child-1 menu-item-id-8' data-page-id='8' value='8'  data-item-id='8'   data-parent-page-id='0'  data-subtype='dynamic'    data-is-shop=true   title='Shop' >Shop</option><option class='pages_tree_item is_page   depth-1 item_7 child-2 menu-item-id-7' data-page-id='7' value='7'  data-item-id='7'   data-parent-page-id='0'  data-subtype='static'     title='Services' >Services</option><option class='pages_tree_item is_page   depth-1 item_24 child-3 menu-item-id-24' data-page-id='24' value='24'  data-item-id='24'   data-parent-page-id='0'  data-subtype='static'     title='About us' >About us</option><option class='pages_tree_item is_page   depth-1 item_5 child-4 menu-item-id-5' data-page-id='5' value='5'  data-item-id='5'   data-parent-page-id='0'  data-subtype='static'     title='Contact Us' >Contact Us</option></select>
</div>
                            </div>
                        </div>
                                    </div>
            ...
            <div class="card-body pt-3">
                                    ...
                                    <div class=' module module-menu ' id='module-content-edit-menu'  data-mw-title="Menu" view="edit_page_menus"   content_id="1"   parent-module-id="module-content-edit"   parent-module="content/edit"   data-type="menu"  >
...
<div class="position-relative" id="menu-selector-item">
            <div id="mw-menu-selector-list-62f3bf933c2e7" class="mw-menu-selector-list">
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-1" class="custom-control-input" name="add_content_to_menu[]"  checked="checked"  value="1"
                               type="checkbox"   data-menu-key="header_menu"  >
                        <label class="custom-control-label" for="menuid-1">Header Menu</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-3" class="custom-control-input" name="add_content_to_menu[]"  checked="checked"  value="3"
                               type="checkbox"   data-menu-key="footer_menu"  >
                        <label class="custom-control-label" for="menuid-3">Footer Menu</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-5" class="custom-control-input" name="add_content_to_menu[]"  value="5"
                               type="checkbox"   data-menu-key="top_menu_1"  >
                        <label class="custom-control-label" for="menuid-5">Top Menu 1</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-6" class="custom-control-input" name="add_content_to_menu[]"  value="6"
                               type="checkbox"   data-menu-key="top_menu_2"  >
                        <label class="custom-control-label" for="menuid-6">Top Menu 2</label>
                    </div>
                </div>
                            <div class="form-group">
                    <div class="custom-control custom-checkbox">
                        <input id="menuid-7" class="custom-control-input" name="add_content_to_menu[]"  value="7"
                               type="checkbox"   data-menu-key="footer_menu_1"  >
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/a4af72b2aafc00d971c59a296d29764ac0a1aebb.blade.php ENDPATH**/ ?>