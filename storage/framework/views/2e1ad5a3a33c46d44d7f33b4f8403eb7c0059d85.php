...
<body class="is_admin loading view-shop action-">

<?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('livewire-ui-modal')->html();
} elseif ($_instance->childHasBeenRendered('lLAyHEO')) {
    $componentId = $_instance->getRenderedChildComponentId('lLAyHEO');
    $componentTag = $_instance->getRenderedChildComponentTagName('lLAyHEO');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('lLAyHEO');
} else {
    $response = \Livewire\Livewire::mount('livewire-ui-modal');
    $html = $response->html();
    $_instance->logRenderedChild('lLAyHEO', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<div class="form-group text-center">
    ...
    <main class="module-shop">

                    <div class=' module module-shop '   data-mw-title="Online shop" view="admin"   backend="true"   id="mw-main-module-backend"   data-type="shop"   parent-module="shop"   parent-module-id="mw-main-module-backend"  >
    <div class=' module module-admin-modules-info ' id='mw-main-module-backend-admin-modules-info'  parent-module-id="mw-main-module-backend"   parent-module="shop"   data-type="admin/modules/info"  ><script>
...
<div class="position-relative">
    <div class="main-toolbar mw-modules-toolbar-back-button-holder" id="mw-modules-toolbar" style="display: none">
                    <a  href="http://127.0.0.1:8000/admin/view:modules" class="btn btn-link text-silver px-0"><i class="mdi mdi-chevron-left"></i> Back</a>
            ...
            <div class=' module module-content-backend '   id="mw-content-backend"   is_shop="y"   parent-module-id="mw-main-module-backend"   parent-module="shop"   data-type="content/backend"  ><script>
    mw.require("content.js");
</script>
<script>
    ...
    function mw_select_page_for_editing($p_id) {
        ...
        //var active_item = $('#pages_tree_container_482146409 .active-bg').first();
        ...
        var active_item = $('#pages_tree_container_482146409 .content-item-' + active_item_is_parent).first();
        ...
        if (active_item_is_category ) {
            var active_item_parent_page = $('#pages_tree_container_482146409 .active-bg').parents('.have_category').first();
            if (active_item_parent_page.length) {
                 active_item_is_page = active_item_parent_page.attr('data-page-id');
            }
            else {
                active_item_parent_page = $('#pages_tree_container_482146409 .active-bg').parents('.is_page').first();
                if (active_item_parent_page.length) {
                     active_item_is_page = active_item_parent_page.attr('data-page-id');
                }
            }
    ...
    function mw_select_custom_content_for_editing($p_id, $type) {
        ...
        if (active_item_is_category != undefined) {
            ...
            var active_bg = document.querySelector('#pages_tree_container_482146409 .active-bg');
...
<div id="edit-content-row">
        ...
        <div class="js-tree tree">
            <div class="tree-column-holder">
                ...
                <div class="fixed-side-column">
                    ...
                    <div class="fixed-side-column-container mw-tree" id="pages_tree_container_482146409">
                        <script>
                            var pagesTree;
                            ...
                            var pagesTreeRefresh = function () {
                                ...
                                request.open('GET', 'http://127.0.0.1:8000/api/content/get_admin_js_tree_json?is_shop=1', true);
                                request.send();
                                    ...
                                    if (request.status >= 200 && request.status < 400) {
                                        ...
                                        if(!data || !data.length){
                                            ...
                                            pagesTree = new mw.tree({
                                                data: data,
                                                element: $("#pages_tree_container_482146409")[0],
                                                sortable: false,
                                                selectable: false,
                                                toggleSelect: false,
                                                id: 'admin-main-tree',
    ...
    <div id="pages_edit_container"  is_shop='y' ></div>
</div>
</div>
    </div>        
...
<?php /**PATH D:\laragon\www\LARAVEL\microweber-master\storage\framework\views/03c48c595ff4e3eddff1865f037334975322de6f.blade.php ENDPATH**/ ?>